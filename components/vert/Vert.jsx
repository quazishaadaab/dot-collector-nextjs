...
// let text_gap='xl:pl-[100px]  2xl:pl-[125px]'
  ...
  let text_gap='xl:pl-[45px] 2xl:pl-[80px]'
...
{/* <Tooltip placement="bottom"  content={attributes} color='invert' rounded >
  ...
  return (
    <div className={`  ${margin_top} ${gap}  pt-2 mb-4 pl-3`}>
{/* 
...
<Tooltip placement="top-right" content={attributes} color='invert' rounded >
<div className={` ${text_font}  font-semibold antialiased hover:italic rounded h-[3.6rem] w-[5.5rem] 2xl:w-[6.5rem] text-start text-clip font-light  bg-clip-text  text-transparent   bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 tracking-tighter`}>
